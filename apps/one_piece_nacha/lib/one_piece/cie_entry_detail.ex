defmodule OnePiece.Nacha.CieEntryDetail do
  import NimbleParsec
  import OnePiece.Nacha.Helpers
  import OnePiece.Nacha.CieAddenda, only: [cie_addenda: 0]
  ...
  def cie_entry_detail do
    ...
    |> trace_number()
    |> eol()
    |> optional(cie_addenda())
    |> post_traverse({__MODULE__, :post_traverse, []})
    |> label("CIE Entry Detail")
  end
end
