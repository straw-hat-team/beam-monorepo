defmodule OnePiece.Configurable.MixProject do
  use Mix.Project

  @app :one_piece_configurable
  @version "0.1.0"
  @elixir_version "~> 1.13"
  ...
  def project do
    [
      ...
      deps_path: "../../deps",
      lockfile: "../../mix.lock",
      name: "OnePiece.Configurable",
      description: "A Swiss Army Knife to deal with Config module",
      app: @app,
      version: @version,
