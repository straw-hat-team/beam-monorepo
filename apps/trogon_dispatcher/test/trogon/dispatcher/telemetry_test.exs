defmodule Trogon.Dispatcher.TelemetryTest do
  ...
  describe "start event" do
    ...
    test "carries the compile-time facts and the context" do
      ...
      assert metadata.command == Support.RegisterUser
      ...
      assert metadata.context.command == %Support.RegisterUser{email: "a@b.c"}
    end

    test "reports the kind of a query" do
      Support.RootDispatcher.dispatch_command(%Support.GetUser{id: 1}, %DispatchOptions{assigns: %{trail: []}})
  ...
  describe "stop event" do
    ...
    test "reports success as a flat result dimension" do
      Support.RootDispatcher.dispatch_command(%Support.RegisterUser{email: "a@b.c"}, %DispatchOptions{
        assigns: %{trail: []}
      })
    ...
    test "reports failure and carries the error term" do
      Support.RootDispatcher.dispatch_command(%Support.FailingCommand{}, %DispatchOptions{assigns: %{trail: []}})
    ...
    test "counts a middleware short circuit as a failure" do
      Support.RootDispatcher.dispatch_command(%Support.RegisterUser{}, %DispatchOptions{actor: :forbidden})
    ...
    test "measures the whole dispatch including middleware" do
      Support.RootDispatcher.dispatch_command(%Support.RegisterUser{}, %DispatchOptions{assigns: %{trail: []}})
  ...
  describe "exception event" do
    ...
    test "fires when the handler raises and still lets the exception through" do
      assert_raise RuntimeError, "boom", fn ->
        Support.RootDispatcher.dispatch_command(%Support.ExplodingCommand{}, %DispatchOptions{assigns: %{trail: []}})
      end
  ...
  describe "telemetry prefix" do
    ...
    test "a dispatcher without a configured prefix emits under the default" do
      ...
      Support.AccountsDispatcher.dispatch_command(%Support.RegisterUser{})
  ...
  describe "refute_dispatch/1" do
    test "passes when the command was never dispatched" do
      attach_telemetry!([:support, :root])
