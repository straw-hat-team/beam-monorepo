defmodule Trogon.Commanded.CommandRouter do
  @moduledoc """
  ...
  defmacro __using__(opts) do
    quote do
      ...
      import Trogon.Commanded.CommandRouter
    end
  end
  ...
  3. When no lifespan module is provided, it uses `Trogon.Commanded.Aggregate.StatelessLifespan`. as the lifespan
  ...
  defmacro register_transaction_script(command_module, opts \\ []) do
    ...
    opts =
      ...
      |> Keyword.put_new(:lifespan, Trogon.Commanded.Aggregate.StatelessLifespan)
