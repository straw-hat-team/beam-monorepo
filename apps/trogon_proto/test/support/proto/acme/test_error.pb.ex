  ...
  def descriptor do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      field: [
        %Google.Protobuf.FieldDescriptorProto{
          ...
          options: %Google.Protobuf.FieldOptions{
            ...
            __pb_extensions__: %{},
            __unknown_fields__: [{870_013, 2, <<8, 3>>}]
          },
          oneof_index: nil,
          json_name: "userId",
          proto3_optional: nil,
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          options: %Google.Protobuf.FieldOptions{
            ...
            __pb_extensions__: %{},
            __unknown_fields__: [
              {870_013, 2, <<8, 3, 18, 8, 117, 115, 101, 114, 45, 97, 112, 105>>}
            ]
          },
          oneof_index: nil,
          json_name: "service",
        ...
        %Google.Protobuf.FieldDescriptorProto{
          ...
          options: %Google.Protobuf.FieldOptions{
            ...
            __pb_extensions__: %{},
            __unknown_fields__: [
              {870_013, 2, <<8, 3, 26, 9, 117, 115, 45, 101, 97, 115, 116, 45, 49>>}
            ]
          },
          oneof_index: nil,
          json_name: "region",
      ...
      options: %Google.Protobuf.MessageOptions{
        ...
        __unknown_fields__: [
          {870_012, 2,
           <<10, 161, 1, 10, 14, 99, 111, 109, 46, 97, 99, 109, 101, 46, 117, 115, 101, 114, 115, 18, 14, 117, 115, 101,
             ...
             100, 32, 5, 40, 3, 50, 44, 10, 27, 104, 116, 116, 112, 115, 58, 47, 47, 100, 111, 99, 115, 46, 97, 99, 109,
             101, 46, 99, 111, 109, 47, 117, 115, 101, 114, 115, 18, 13, 85, 115, 101, 114, 32, 65, 80, 73, 32, 68, 111,
             99, 115, 58, 16, 10, 8, 114, 101, 115, 111, 117, 114, 99, 101, 18, 4, 117, 115, 101, 114, 58, 25, 10, 11,
             116, 101, 110, 97, 110, 116, 95, 107, 105, 110, 100, 18, 8, 105, 110, 116, 101, 114, 110, 97, 108, 24, 2>>}
        ]
      },
      oneof_decl: [],
      reserved_range: [],
  ...
  def descriptor do
    ...
    %Google.Protobuf.DescriptorProto{
      ...
      options: %Google.Protobuf.MessageOptions{
        ...
        __unknown_fields__: [
          {870_012, 2,
           <<10, 77, 10, 15, 99, 111, 109, 46, 97, 99, 109, 101, 46, 115, 121, 115, 116, 101, 109, 18, 21, 105, 110,
             ...
             114, 32, 111, 99, 99, 117, 114, 114, 101, 100, 32, 13>>}
        ]
      },
      oneof_decl: [],
      reserved_range: [],
